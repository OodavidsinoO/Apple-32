...
// 6502 defines
// #define UNDOCUMENTED
// When this is defined, undocumented opcodes are handled. otherwise, they're simply treated as NOPs.

// #define USE_TIMING
// Slower, but allows you to specify number of cycles to run for exec6502 rather than simply a number of instructions. also uses a little more program memory when enabled.
