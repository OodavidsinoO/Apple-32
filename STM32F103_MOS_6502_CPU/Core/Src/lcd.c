...
extern uint8_t LCD_CURSOR_X;
extern uint8_t LCD_CURSOR_Y;
...
void LCD_REG_Config ( void )
{
	...
	DEBUG_DELAY ();
	LCD_Write_Cmd ( 0x36 ); 	
	// LCD_Write_Data ( 0xC8 ); // 0xC8 = 1100 1000 (MY MX MV ML BGR MH 0 0) (Portrait)
...
void LCD_DrawCharColor ( uint16_t usC, uint16_t usP, const char cChar, uint16_t usColor)
{
	uint8_t ucTemp, ucRelativePositon, ucPage, ucColumn;
